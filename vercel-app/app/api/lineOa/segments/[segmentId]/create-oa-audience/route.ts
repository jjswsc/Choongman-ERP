...
import { createLineOaAudienceFromSegment, parseLineOaSegmentPathId } from '@/lib/line-oa-segment-server'
...
export async function POST(_request: NextRequest, context: RouteContext) {
  ...
  try {
    const upstream = await createLineOaAudienceFromSegment(parsedId.segmentId)
