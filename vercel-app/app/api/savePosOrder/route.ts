...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const marketingCampaignIdRaw = body.collabCampaignId ?? body.collab_campaign_id ?? body.marketingCampaignId ?? body.marketing_campaign_id
