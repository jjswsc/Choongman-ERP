...
export default function InteriorExpensePage() {
  ...
  const handleProjectChange = (id: string) => {
    router.replace(`/admin/interior-expense?projectId=${id}`)
  }
      ...
      <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 lg:px-8 space-y-4">
        <div className="flex items-center justify-between gap-4 flex-wrap">
          ...
          <Select
            ...
            onValueChange={(v) => (v === "none" ? router.replace("/admin/interior-expense") : handleProjectChange(v))}
          >
