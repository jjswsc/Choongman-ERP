...
import { canAccessPosOrder, isPosSettlementOnlyRole, canAccessAdmin } from "@/lib/permissions"
...
export default function PosLayout({
  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-slate-50">
      ...
      <main className="flex-1 overflow-hidden flex items-center justify-center p-2 md:p-4">
        {useViewport ? (
