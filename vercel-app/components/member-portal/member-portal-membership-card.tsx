...
export function MemberPortalMembershipCard({
  ...
  return (
    <div
      className={`relative w-full overflow-hidden rounded-[1.5rem] border border-amber-400/20 bg-gradient-to-br ${tier.gradient} shadow-[0_20px_60px_rgba(0,0,0,0.5)] ${tier.glow}`}
      style={{ aspectRatio: MEMBERSHIP_CARD_GOLDEN_RATIO }}
    >
      ...
      <div
        className={`absolute inset-0 flex h-full min-h-0 flex-col p-4 transition-opacity duration-300 ease-out ${
