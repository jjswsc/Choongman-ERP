        ...
        <table className="w-full text-xs">
          <thead>
            <tr className="bg-sidebar text-white">
              <th className="px-3 py-2.5 text-left font-semibold whitespace-nowrap">{t("stockColDate")}</th>
              <th className="px-3 py-2.5 text-left font-semibold">{t("outColItem")}</th>
              <th className="px-3 py-2.5 text-right font-semibold whitespace-nowrap">{t("outColQty")}</th>
              <th className="px-3 py-2.5 text-right font-semibold whitespace-nowrap">{t("inColAmount")}</th>
            </tr>
          </thead>
      ...
      <table className="w-full text-xs">
        <thead>
          <tr className="bg-sidebar text-white">
            ...
            <th className="px-3 py-2.5 text-left font-semibold whitespace-nowrap">{t("orderColDate")}</th>
            <th className="px-3 py-2.5 text-left font-semibold whitespace-nowrap">{t("orderColDeliveryDate")}</th>
            <th className="px-3 py-2.5 text-left font-semibold whitespace-nowrap">{t("outColInvNo")}</th>
            <th className="px-3 py-2.5 text-left font-semibold whitespace-nowrap">{t("outFilterType")}</th>
            <th className="px-3 py-2.5 text-left font-semibold whitespace-nowrap">{t("outColPhoto")}</th>
            <th className="px-3 py-2.5 text-left font-semibold whitespace-nowrap">{t("outColStore")}</th>
            <th className="px-3 py-2.5 text-left font-semibold">{t("outColItem")}</th>
            <th className="px-3 py-2.5 text-right font-semibold whitespace-nowrap">{t("outColQty")}</th>
            <th className="px-3 py-2.5 text-right font-semibold whitespace-nowrap">{t("inColAmount")}</th>
          </tr>
  ...
  return (
    <>
      ...
      >
        ...
        <td className="px-3 py-2.5 text-card-foreground whitespace-nowrap">{row.orderDate}</td>
        <td className="px-3 py-2.5 text-card-foreground whitespace-nowrap">{row.deliveryDate || "-"}</td>
        <td className="px-3 py-2.5 text-card-foreground whitespace-nowrap font-mono text-[11px]">{row.invoiceNo}</td>
        ...
        <td className="px-3 py-2.5 text-card-foreground whitespace-nowrap font-medium">{row.target}</td>
              ...
              <table className="w-full text-xs">
                <thead>
                  <tr className="bg-muted/50">
                    ...
                    <th className="px-4 py-2 text-right font-semibold text-card-foreground">{t("inColAmount")}</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-border">
                  {row.items.map((d, i) => (
