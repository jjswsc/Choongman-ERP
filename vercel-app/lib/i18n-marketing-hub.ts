...
export const I18N_MARKETING_HUB_KO: Record<string, string> = {
  ...
  marketingHeroDescResults: '캠페인을 고르면 그 캠페인의 비용·매출·ROAS와 Facebook 광고 성과를 봅니다.',
  ...
  helpSum_admin_marketing_results: '고른 캠페인의 비용·매출·ROAS와 Facebook 광고 성과를 봅니다.',
...
export const I18N_MARKETING_HUB_EN: Record<string, string> = {
  ...
  marketingHeroDescResults: 'Pick a campaign to see its cost, sales, ROAS, and Facebook ad results.',
  ...
  helpSum_admin_marketing_results: 'See the picked campaign’s cost, sales, ROAS, and Facebook ad results.',
  helpHow_admin_marketing_results:
...
export const I18N_MARKETING_HUB_TH: Record<string, string> = {
  ...
  marketingHeroDescResults: 'เลือกแคมเปญแล้วดูค่าใช้จ่าย ยอดขาย ROAS และผลโฆษณา Facebook ของแคมเปญนั้นครับ',
  ...
  helpSum_admin_marketing_results: 'ดูค่าใช้จ่าย ยอดขาย ROAS และผลโฆษณา Facebook ของแคมเปญที่เลือก',
  helpHow_admin_marketing_results:
