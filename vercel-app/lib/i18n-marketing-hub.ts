...
export const I18N_MARKETING_HUB_KO: Record<string, string> = {
  ...
  adminMarketingAds: '메타 광고',
  adminMarketingTasks: '마케팅 작업',
  adminMarketingResults: '성과 / ROAS',
  ...
  marketingWsTabHint: '이 캠페인만 다루는 탭입니다. 사이드바 「프로모션 세트·협업 할인·마케팅 작업·성과」에서 캠페인을 골라 들어가도 같은 화면입니다.',
  marketingEnterViaCampaign: '스탠디·인플루 작업은 사이드바 「마케팅 작업」에서 캠페인을 골라 하는 것이 기본입니다.',
  marketingEnterViaCampaignCta: '마케팅 작업으로',
  ...
  marketingHeroDescTasks: '캠페인을 고르면 그 캠페인의 스탠디·포스터·인플루언서 작업을 칸반으로 관리합니다.',
  marketingHeroDescResults: '캠페인을 고르면 그 캠페인의 비용·매출·ROAS와 Meta(Facebook·Instagram) 광고 성과를 봅니다.',
  marketingScopedPickCampaign: '캠페인 선택',
  marketingScopedPickCampaignHint: '캠페인을 고르면 그 캠페인만 다룹니다. 고른 캠페인은 다른 마케팅 메뉴로 옮겨도 유지됩니다.',
  marketingScopedOpenWorkspace: '전체 워크스페이스',
  marketingScopedEmptyTasks: '캠페인을 골라 작업을 관리하세요.',
  marketingScopedEmptyResults: '캠페인을 골라 성과를 확인하세요.',
  marketingHeroDescAds: 'Meta(Facebook·Instagram) 광고 성과와 SNS 부스트 실비를 캠페인에 연결하고 ROAS에 반영합니다.',
  ...
  helpHow_admin_marketing_campaigns:
    '① 「새 캠페인」으로 이름·기간을 넣고 저장하면 워크스페이스로 갑니다.\n② 카드 본문은 개요, 아래 링크는 프로모·협업·작업·성과 탭입니다.\n③ 사이드바 「프로모션 세트·협업 할인·마케팅 작업·성과」에서 캠페인을 골라 들어가도 같은 화면입니다.',
  helpSum_admin_marketing_collab_menus: '협업·제휴 캠페인의 POS 할인·증빙·적용 범위를 캠페인별로 관리합니다.',
  ...
  helpSum_admin_marketing_results: '고른 캠페인의 비용·매출·ROAS와 Meta(Facebook·Instagram) 광고 성과를 봅니다.',
  helpHow_admin_marketing_results:
    '① 상단에서 캠페인을 고릅니다.\n② 통장·Petty 실비와 POS 매출을 합쳐 ROAS를 계산합니다.\n③ Meta 성과는 워크스페이스 개요에서 고른 Ads 캠페인 기준입니다. 비어 있으면 연동에서 페이지를 연결하고 동기화하세요.',
  helpSum_admin_marketing_ads: 'Meta(Facebook·Instagram) Ads 성과와 SNS 부스트 실비를 캠페인에 연결합니다.',
  helpHow_admin_marketing_ads:
    '① 사이드바 「메타 광고」에서 Meta 성과(Facebook·Instagram) 탭으로 동기화된 숫자를 봅니다.\n② 등록 탭에서 플랫폼·주제·집행 기간·예산·실비를 저장합니다.\n③ 워크스페이스 개요에서 동기화된 Meta Ads 캠페인을 고르면 그 지출만 보입니다.',
  ...
  marketingMetaMapLabel: 'Meta 광고 캠페인',
  marketingMetaMapPh: 'Ads Manager에 보이는 캠페인 이름',
  marketingMetaMapNone: '연결 안 함',
  marketingMetaMapCustom: '직접 입력',
  marketingMetaMapSyncFirst: '연동에서 데이터를 동기화하면 여기서 Meta Ads 캠페인을 고를 수 있습니다.',
  marketingHomeShowMore: '더 보기',
  marketingHomeShowLess: '접기',
  marketingMetaAdsTitle: '메타 광고',
  marketingMetaAdsSubtitle: 'Meta Ads 최근 28일 · Facebook·Instagram',
  ...
  marketingAdsTabMeta: 'Facebook·Instagram',
...
export const I18N_MARKETING_HUB_EN: Record<string, string> = {
  ...
  adminMarketingAds: 'Meta ads',
  adminMarketingTasks: 'Marketing work',
  adminMarketingResults: 'Results / ROAS',
  ...
  marketingWsTabHint: 'These tabs cover this campaign only. The sidebar menus (Promo sets, Collab discounts, Marketing work, Results) open the same screens once you pick a campaign.',
  marketingEnterViaCampaign: 'Standee and influencer work is normally done from the Marketing work menu after picking a campaign.',
  marketingEnterViaCampaignCta: 'Go to marketing work',
  ...
  marketingHeroDescTasks: 'Pick a campaign to run its standee, poster, and influencer work on a kanban board.',
  marketingHeroDescResults: 'Pick a campaign to see its cost, sales, ROAS, and Meta (Facebook·Instagram) ad results.',
  marketingScopedPickCampaign: 'Pick a campaign',
  marketingScopedPickCampaignHint: 'Pick a campaign and this screen covers only that campaign. The choice follows you across marketing menus.',
  marketingScopedOpenWorkspace: 'Full workspace',
  marketingScopedEmptyTasks: 'Pick a campaign to manage its work.',
  marketingScopedEmptyResults: 'Pick a campaign to see its results.',
  marketingHeroDescAds: 'Connect Meta (Facebook·Instagram) ad results and SNS boost spend to campaigns for ROAS.',
  ...
  helpHow_admin_marketing_campaigns:
    '① Use New campaign to save a name and dates, then the workspace opens.\n② The card body opens overview; footer links go to promo, collab, tasks, results.\n③ The sidebar menus (Promo sets, Collab discounts, Marketing work, Results) open the same screens once you pick a campaign.',
  helpSum_admin_marketing_collab_menus: 'Manage partner/collab POS discounts, proof, and menu scope per campaign.',
  helpHow_admin_marketing_collab_menus:
  ...
  helpSum_admin_marketing_results: 'See the picked campaign’s cost, sales, ROAS, and Meta (Facebook·Instagram) ad results.',
  helpHow_admin_marketing_results:
    '① Pick a campaign at the top.\n② Bank and petty spend is combined with POS sales to compute ROAS.\n③ Meta numbers follow the Ads campaign chosen in the workspace overview. If empty, connect a page under Integrations and sync.',
  helpSum_admin_marketing_ads: 'Meta (Facebook·Instagram) Ads results plus SNS boost spend linked to campaigns.',
  helpHow_admin_marketing_ads:
    '① Open Meta ads in the sidebar and use the Facebook·Instagram tab for synced numbers.\n② On Compose, save platform, topic, dates, budget, and actual spend.\n③ Pick a synced Meta Ads campaign on Overview to filter spend.',
  ...
  marketingMetaMapLabel: 'Meta ads campaign',
  ...
  marketingMetaMapSyncFirst: 'Sync data under Integrations to pick a Meta Ads campaign here.',
  marketingHomeShowMore: 'Show more',
  marketingHomeShowLess: 'Show less',
  marketingMetaAdsTitle: 'Meta ads',
  marketingMetaAdsSubtitle: 'Meta Ads — last 28 days · Facebook·Instagram',
...
export const I18N_MARKETING_HUB_TH: Record<string, string> = {
  ...
  adminMarketingAds: 'โฆษณา Meta',
  adminMarketingTasks: 'งานการตลาด',
  adminMarketingResults: 'ผลลัพธ์ / ROAS',
  ...
  marketingWsTabHint: 'แท็บด้านบนดูเฉพาะแคมเปญนี้ครับ เมนูซ้าย (โปรโมชันเซ็ต ส่วนลดความร่วมมือ งานการตลาด ผลลัพธ์) เลือกแคมเปญแล้วจะเห็นหน้าเดียวกันครับ',
  marketingEnterViaCampaign: 'งานสแตนดี้กับอินฟลู ปกติทำที่เมนู「งานการตลาด」โดยเลือกแคมเปญก่อนครับ',
  marketingEnterViaCampaignCta: 'ไปงานการตลาด',
  ...
  marketingHeroDescTasks: 'เลือกแคมเปญแล้วจัดการงานสแตนดี้ โปสเตอร์ และอินฟลูของแคมเปญนั้นบนบอร์ดคัมบังครับ',
  marketingHeroDescResults: 'เลือกแคมเปญแล้วดูค่าใช้จ่าย ยอดขาย ROAS และผลโฆษณา Meta (Facebook·Instagram) ของแคมเปญนั้นครับ',
  marketingScopedPickCampaign: 'เลือกแคมเปญ',
  marketingScopedPickCampaignHint: 'เลือกแคมเปญแล้วหน้านี้จะดูเฉพาะแคมเปญนั้น และจะจำไว้เมื่อสลับไปเมนูการตลาดอื่นครับ',
  marketingScopedOpenWorkspace: 'หน้าแคมเปญเต็ม',
  marketingScopedEmptyTasks: 'เลือกแคมเปญเพื่อจัดการงานครับ',
  marketingScopedEmptyResults: 'เลือกแคมเปญเพื่อดูผลลัพธ์ครับ',
  marketingHeroDescAds: 'เชื่อมผลโฆษณา Meta (Facebook·Instagram) และค่าบูสต์ SNS กับแคมเปญสำหรับ ROAS',
  ...
  helpHow_admin_marketing_campaigns:
    '① กดสร้างแคมเปญใหม่ ใส่ชื่อกับช่วงวันที่ แล้วจะเปิดหน้าแคมเปญครับ\n② ตัวการ์ดเปิดภาพรวม ลิงก์ล่างไปโปรโม ร่วมมือ งาน ผลงาน\n③ เมนูซ้าย (โปรโมชันเซ็ต ส่วนลดความร่วมมือ งานการตลาด ผลลัพธ์) เลือกแคมเปญแล้วจะเห็นหน้าเดียวกันครับ',
  helpSum_admin_marketing_collab_menus: 'จัดการส่วนลด POS หลักฐาน และขอบเขตความร่วมมือ ตามแคมเปญ',
  helpHow_admin_marketing_collab_menus:
  ...
  helpSum_admin_marketing_results: 'ดูค่าใช้จ่าย ยอดขาย ROAS และผลโฆษณา Meta (Facebook·Instagram) ของแคมเปญที่เลือก',
  helpHow_admin_marketing_results:
    '① เลือกแคมเปญด้านบนครับ\n② ระบบรวมค่าใช้จ่ายจากบัญชี/Petty กับยอดขาย POS เพื่อคำนวณ ROAS\n③ ตัวเลข Meta อิงแคมเปญโฆษณาที่เลือกไว้ในภาพรวม ถ้าว่างให้ไปเชื่อมเพจที่หน้าเชื่อมต่อแล้วซิงก์ครับ',
  helpSum_admin_marketing_ads: 'ผลโฆษณา Meta (Facebook·Instagram) และค่าบูสต์ SNS ที่เชื่อมกับแคมเปญ',
  helpHow_admin_marketing_ads:
    '① เปิดเมนูโฆษณา Meta แล้วดูแท็บ Facebook·Instagram สำหรับตัวเลขที่ซิงค์มา\n② แท็บลงทะเบียน: บันทึกแพลตฟอร์ม หัวข้อ ช่วงเวลา งบ และค่าใช้จริง\n③ ที่ภาพรวมแคมเปญเลือกแคมเปญ Meta Ads ที่ซิงค์มาแล้วเพื่อกรองค่าใช้จ่ายครับ',
  ...
  marketingMetaMapLabel: 'แคมเปญโฆษณา Meta',
  marketingMetaMapPh: 'ชื่อแคมเปญตาม Ads Manager',
  marketingMetaMapNone: 'ไม่เชื่อม',
  marketingMetaMapCustom: 'พิมพ์ชื่อเอง',
  marketingMetaMapSyncFirst: 'ไปซิงค์ข้อมูลที่เมนูการเชื่อมต่อ แล้วจะเลือกแคมเปญ Meta Ads ได้ที่นี่ครับ',
  marketingHomeShowMore: 'ดูเพิ่ม',
  marketingHomeShowLess: 'ย่อ',
  marketingMetaAdsTitle: 'โฆษณา Meta',
  marketingMetaAdsSubtitle: 'Meta Ads — 28 วันล่าสุด · Facebook·Instagram',
