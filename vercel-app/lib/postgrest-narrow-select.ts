...
export const ATTENDANCE_LOG_PAYROLL_COLS =
  'log_at,store_name,name,log_type,late_min,early_min,ot_min,break_min,status,approved'
...
export const STOCK_LOG_OUTBOUND_HISTORY_COLS =
  'log_type,log_date,vendor_target,item_code,item_name,qty,order_id,delivery_status,invoice_unit_price'
