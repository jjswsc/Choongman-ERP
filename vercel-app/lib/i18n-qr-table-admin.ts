...
export const I18N_QR_TABLE_ADMIN_KO: Record<string, string> = {
  ...
  qrTableSessionStaffCallShort: '호출',
  qrTableSessionCallBill: '계산 요청',
  qrTableSessionCallHelp: '도움 요청',
  qrTableSessionCallWater: '물 요청',
  qrTableSessionCallBillShort: '계산',
  qrTableSessionCallHelpShort: '도움',
  qrTableSessionCallWaterShort: '물',
  qrTableSessionAckCall: '확인',
...
export const I18N_QR_TABLE_ADMIN_EN: Record<string, string> = {
  ...
  qrTableSessionOrdering: 'Ordering on QR',
  qrTableSessionAwaitPrepay: 'Waiting for package payment',
  qrTableSessionAwaitConfirm: 'Confirm package (pay later)',
  ...
  qrTableSessionStaffCallShort: 'CALL',
  qrTableSessionCallBill: 'Check please',
  qrTableSessionCallHelp: 'Help',
  qrTableSessionCallWater: 'Water',
  qrTableSessionCallBillShort: 'BILL',
  qrTableSessionCallHelpShort: 'HELP',
  qrTableSessionCallWaterShort: 'WATER',
  qrTableSessionAckCall: 'Got it',
...
export const I18N_QR_TABLE_ADMIN_TH: Record<string, string> = {
  ...
  qrTableExtraMenus: 'เมนูเพิ่ม (คิดเงิน)',
  qrTableExtraMenusHint:
  ...
  qrTableSessionStaffCallShort: 'เรียก',
  qrTableSessionCallBill: 'ขอเช็คบิล',
  qrTableSessionCallHelp: 'ขอความช่วยเหลือ',
  qrTableSessionCallWater: 'ขอน้ำ',
  qrTableSessionCallBillShort: 'บิล',
  qrTableSessionCallHelpShort: 'ช่วย',
  qrTableSessionCallWaterShort: 'น้ำ',
  qrTableSessionAckCall: 'รับทราบ',
