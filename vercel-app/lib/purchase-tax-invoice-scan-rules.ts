...
export const PURCHASE_TAX_SCAN_RULES: PurchaseTaxScanRuleCase[] = [
  ...
  {
    id: 'inv-tpd-green-form-not-po-or-print-date',
    field: 'invoiceNo',
    title: 'TPD เลขที่เอกสาร 102608000072. PO 11·โครงการ·วันที่พิมพ์ 금지',
    taxMonth: AUG,
    text: page(
  ...
  {
    id: 'name-not-buyer-after-customer-code',
    field: 'sellerName',
    title: '헤더 판매자. ลูกค้า 다음 우리 상호·브랜드 금지',
    taxMonth: '2026-07',
    text: page(
      'บริษัท คอมมอนวิว จำกัด (สำนักงานใหญ่)',
      'เลขที่ 94 ถนนพหลโยธิน',
      ...
      '1) น้ำแข็งหลอดเล็กแพ็คถุงใส 1 ถุง 60.00',
      'ส่วนลด 0.00',
    ...
    expect: {
      invoiceNo: 'APIICE260700119',
      invoiceNoNot: /RT-|6260100004|C260100004|0111APIICE/i,
      sellerName: /คอมมอนวิว/,
      sellerNameNot: /เอเซีย คอมเมิร์ซ|เอเชีย คอมเมิร์ซ/i,
      sellerTaxId: '0135545006400',
      sellerTaxIdNot: '0105568080622',
      netAmount: 56.07,
      vatAmount: 3.93,
    },
  ...
  {
    id: 'inv-not-ref-or-customer-code',
    field: 'invoiceNo',
    title: 'เลขที่เอกสาร. เอกสารอ้างอิง RT·고객코드 C→6 금지',
    taxMonth: '2026-07',
    text: page(
      ...
      'บริษัท เอเซีย คอมเมิร์ซ แอนด์ เทรด จำกัด',
      'เลขประจำตัวผู้เสียภาษี 0105568080622',
      'เอกสารอ้างอิง วันที่ เลขที่เอกสาร',
      'RT-20260702-0111APIICE260700119',
      'วันที่ 02/07/2026',
      'ยอดรวมก่อนภาษี 56.07',
      'ภาษีมูลค่าเพิ่ม 3.93',
      'ยอดเงินสุทธิ 60.00'
    ),
    expect: {
      invoiceNo: 'APIICE260700119',
      invoiceNoNot: /RT-|6260100004|C260100004/i,
      sellerName: /คอมมอนวิว/,
      sellerNameNot: /เอเซีย คอมเมิร์ซ/i,
    },
  },
  {
    id: 'name-not-buyer-without-hint',
    field: 'sellerName',
    title: '구매자 TIN 힌트 없어도 ลูกค้า 블록은 우리 상호가 아님',
    taxMonth: '2026-07',
    buyerTaxId: '',
    text: page(
      'บริษัท ไอซ์ เทสต์ จำกัด (สำนักงานใหญ่)',
      'เลขประจำตัวผู้เสียภาษี 0135545006400',
      'ลูกค้า: C260100004',
      'Choongman Chicken',
      'บริษัท เอเชีย คอมเมิร์ซ แอนด์ เทรด จำกัด',
      'เลขประจำตัวผู้เสียภาษี 0105568080622',
      'เลขที่เอกสาร ICE260700088',
      'วันที่ 05/07/2026',
      'มูลค่าสินค้า 100.00',
      'ภาษีมูลค่าเพิ่ม 7.00',
      'รวมทั้งสิ้น 107.00'
    ...
    expect: {
      invoiceNo: 'ICE260700088',
      sellerName: /ไอซ์ เทสต์/,
      sellerNameNot: /เอเซีย คอมเมิร์ซ|เอเชีย คอมเมิร์ซ/i,
      sellerTaxId: '0135545006400',
      sellerTaxIdNot: '0105568080622',
    },
