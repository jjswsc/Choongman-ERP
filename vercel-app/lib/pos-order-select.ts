...
export const POS_ORDER_POLL_MINIMAL_SELECT =
  'id,order_no,store_code,order_type,table_name,memo,items_json,subtotal,vat,discount_amt,coupon_discount_amt,discount_reason,delivery_fee,packaging_fee,service_amt,total,status,created_at,guest_count,delivery_app_code,payment_cash,payment_cash_tendered,payment_card,payment_qr,payment_other,payment_delivery_app,delivery_payment_channel,applied_coupons'
